# LESSONS.md - [DEPRECATED] MVP 12 节微课与延伸路径

> ⚠️ **本文件自 v0.4.0(2026-05-14)起 deprecated。**
>
> **原因**：v2.0 框架重做后，**32 章教材（AI 通识 16 章 + AIPM 16 章，v0.3.0 完成）成为唯一系统化内容**。12 节课和教材内容重叠，作为主线已废除。
>
> **本文件保留为历史参考**：
> - 不再用于主流程设计
> - `lib/courses/built-in-courses.ts` 在迁移期可能仍被引用，但 v0.4.x 起逐步迁移到 `lib/textbooks/*` 数据
> - 12 节课的内容已在 32 章教材里有更系统化的呈现
>
> **新需求改动请参考**：
> - `PRD.md` v2.0 —— 4 大学习线 / 持续学习区 / 资产沉淀
> - `ROADMAP.md` —— 5 阶段路线图
> - `lib/textbooks/ai/c01-c16.json` + `lib/textbooks/aipm/c01-c16.json` —— 教材正文
> - `lib/textbooks/registry.ts` —— 教材元数据
>
> **不要再基于本文件做新 feature。**

---

当前版本：v0.1.0 MVP 内容定稿版（已废弃）
最后更新：2026-05-11 / 2026-05-14 标 deprecated

本文件曾是 MVP 第一批内置课程的完整数据源。**v0.4.0 起不再作为产品真理源**，仅保留作为参考。
